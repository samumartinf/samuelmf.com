    ...
    return (
        <Helmet
            ...
            link = {[
                ...
                { rel: "icon", type: "image/x-icon", sizes: "48x48", href: "/weblogo.ico" },
                { rel: "apple-touch-icon", type: "image/png", sizes: "180x180", href: "/weblogo.png" }, 
                { rel: "alternate", type: "application/rss+xml", title: "SamuelMF", href: "/rss.xml" },
            ]}
        />
    )
}
